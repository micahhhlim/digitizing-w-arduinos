...
//---------------------------------------------------------------------------//
byte sine_data [91]= //define array as a global variable. [91] indicates value of sin from 1 to 90.
 {
0,  
...
//example
  ...
  t=micros();
FFT(data,128,100);        //to get top five value of frequencies of X having 64 sample at 100Hz sampling
//Serial.println(f_peaks[0]);
//Serial.println(f_peaks[1]);
Serial.println(micros()-t); // printing a time in microsecond 
delay(1000000);
...
Serial.print("\t");                                     // un comment to print RAW o/p = prints all our frequencies in terms of complex numbers   
